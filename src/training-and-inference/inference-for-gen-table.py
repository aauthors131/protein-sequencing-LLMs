# This inference used HuggingFace's pipeline package - "fill-mask" task to get the masked token
# It store the result (including scoreboard, very large) in json, est. 13-15hr on 1 A100_10Gb GPU per set of amino acids
# Known amino acids: KCYM + 1 from RHWST 
# DO ONE-BY-ONE to update masking_letters, 
# or modify this script to loop through appropriate masking_letter per known sets
# %%
...
test_set = []
masking_letters = r"[AQNGDEILFPVRWST]"
...
# %%
input_args=[ # one-by-one!!!! cuz needed to change vocab
    # {
    #     # 'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-Coli-FFT/KCYMS/checkpoint-7000",
    #     # 'outname' : f"inference-results/KCYS/E-Coli",
    #     'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-Coli-FFT/KCYMS/checkpoint-25500",
    #     'outname' : f"inference-results/KCYS/E-Coli-cp25.5k",
    # },    
    # {
    #     # 'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-Coli-FFT/KCYMT/checkpoint-6000",
    #     # 'outname' : f"inference-results/KCYT/E-Coli",
    #     'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-Coli-FFT/KCYMT/checkpoint-24500",
    #     'outname' : f"inference-results/KCYT/E-Coli-cp24.5k",
    # },     
    # {
    #     # 'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-Coli-FFT/KCYMW/checkpoint-6000",
    #     # 'outname' : f"inference-results/KCYW/E-Coli",
    #     'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-Coli-FFT/KCYMW/checkpoint-23000",
    #     'outname' : f"inference-results/KCYW/E-Coli-cp23k",
    # },    
    # {
    #     'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-Coli-FFT/KCYMR/checkpoint-26000",
    #     'outname' : f"inference-results/KCYR/E-Coli",
    # },    
    {
        'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-Coli-FFT/KCYMH/checkpoint-27000",
        'outname' : f"inference-results/KCYH/E-Coli",
    },    
    ]
...
for arg_list in input_args:
    ...
    #             {'min_length':   250, 'max_length':   500, 'batch_size':    16},
    #             {'min_length':   500, 'max_length':   750, 'batch_size':     8},
    #             {'min_length':   750, 'max_length': 1_000, 'batch_size':     8},
    #             {'min_length': 1_000, 'max_length': 2_000, 'batch_size':     8},                
    #             {'min_length': 2_000, 'max_length': 5_000, 'batch_size':     8},
    #             {'min_length': 5_000, 'max_length': 100000000000000000000000, 'batch_size':1},                
    #             ]
