...
# It store the result (including scoreboard, very large) in json, est. time: 8-10 hrs using A100_10Gb GPU 
# Known amino acids: KCYM
...
test_set = []
masking_letters = r"[AQNGDEILFPVRHWST]"
...
input_args=[
    {
        'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-Coli-FFT/KCYM/checkpoint-16500",
        'outname' : f"inference-results/KCYM/E-Coli-to-others",
    },    
    
    # {
    #     'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-albertii-FFT/KCYM/checkpoint-16000",
    #     'outname' : f"inference-results/KCYM/E-albertii-to-others",
    # },    
    
    # {
    #     'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-fergusonii-FFT/KCYM/checkpoint-16500",
    #     'outname' : f"inference-results/KCYM/E-fergusonii-to-others",
    # },    
    ## --------------    
    # {
    #     'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-Coli-FFT/KCYM/checkpoint-7000",
    #     'outname' : f"inference-results/KCYM/E-Coli-to-others-cp7000",
    # },    
    
    # {
    #     'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-albertii-FFT/KCYM/checkpoint-7000",
    #     'outname' : f"inference-results/KCYM/E-albertii-to-others-cp7000",
    # },    
    
    # {
    #     'model_path' : f"/home/tlp5359/projects/CC_Sequencing_LLM/BCB/models/E-fergusonii-FFT/KCYM/checkpoint-7000",
    #     'outname' : f"inference-results/KCYM/E-fergusonii-to-others-cp7000",
    # },    
    ]
