# Continue training from pre-trained model: Rostlab/prot_bert
# evaluation strategy: CE-loss
# we resume training until manually evaluate both loss and accuracy plots.
